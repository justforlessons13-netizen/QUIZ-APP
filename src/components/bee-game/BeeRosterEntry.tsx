  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col gap-3">
        <div className="flex items-center gap-2 text-[11px] uppercase tracking-[2px] text-primary/80">
        ...
        <div className="flex items-center gap-2.5">
          <input
            ...
            className="flex-1 bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl py-3.5 px-4 text-sm text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:border-primary/50 transition-colors tracking-wider"
          />
          <button
            onClick={handleAdd}
            disabled={!name.trim()}
